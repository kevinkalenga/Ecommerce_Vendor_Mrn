    ...
    <div className='px-2 lg:px-7 pt-5'>
       <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
           <div className='flex justify-between items-center pb-4'>
              ...
              <Link className='bg-blue-500 hover:shadow-blue-500/50
                   ...
                   <div className='flex flex-col w-full gap-1'>
                      ...
                      <input className='px-4 py-2 focus:border-indigo-500
                       outline-none bg-[#6a5fdf] border border-slate-700
                        rounded-md text-[#d0d2d6]' type="text" name="name" id="name" 
                        placeholder='Product name' onChange={inputHandle} value={state.name} />
                   </div>
                   <div className='flex flex-col w-full gap-1'>
