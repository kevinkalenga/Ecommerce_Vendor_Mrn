        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>Kevin Kalenga </td>
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>kevinkalenga10@gmail.com</td>
               ...
               <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>
                ...
                <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>
                    ...
                    <Link to='/admin/dashboard/sellers/details/2' className='p-[6px] bg-green-500 rounded 
