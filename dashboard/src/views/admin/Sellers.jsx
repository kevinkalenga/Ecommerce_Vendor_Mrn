...
const Sellers = () => {
    ...
    <div className='px-2 lg:px-7 pt-5'>
        <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>King Kevin</td>
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>kevinkalenga10@gmail.com</td>
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                  <div className='flex justify-start items-center gap-4'>
                     <Link className='px-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50'>
                         <FaEye />
                     </Link> 
